...
<a href="http://localhost/tnp2mod/"><input type="submit" value="HOME"  name="back" style="width:80px ; padding-left:100px; margin-left: 50px;  height:50px; background-color: blue;"></a>
</body>
</html>
<?php
...
ob_start();
    ...
    if(isset($_POST['login']))
   {
       ...
       header('Location: adminprofmain.php');
   }
          }
 else
 {
  ...
  echo"hey";
    ...
    if($result = $conn->query($sql))
                 ...
                 if($result->num_rows > 0)
         {
            ...
            $row = $result->fetch_assoc();
            $_SESSION['login_user']=$eemail;
      header('Location:studprofmain.php');
  }
}
else
{
  ...
  echo"hey";
        ...
        else if($var==3) 
        {
                 ...
                 if($result->num_rows > 0)
         {
            ...
            $row = $result->fetch_assoc();
            $_SESSION['login_user']=$eemail;
      header('Location: companyprofmain.php');
  }
}
else
{
