...
{
    $id=$_GET["email"];
    $sql2="SELECT * FROM selected_student,company_criteria  where company_criteria.email='$id' and company_criteria.cid=selected_student.cid and selected_student.status2=3";
