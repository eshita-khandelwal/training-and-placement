...
//     $sql5='UPDATE  company SET cstatus=1 where cid=(select cid from selected_student where status2=3) and email=\''.$user.'\';';
//     $result5=$conn->query($sql5);
//     $sql3="UPDATE student set status=1 where  mis='$id'";
...
$id=$_GET["mis"];
  $sql2="UPDATE  selected_student SET status2=3 where mis='$id' and  cid=$cmid";
     $result2=$conn->query($sql2);
     $sql5='UPDATE  company SET cstatus=1 where cid=(select cid from selected_student where status2=3) and email=\''.$user.'\';';
     $result5=$conn->query($sql5);
     $sql3="UPDATE student set status=1 where  mis='$id'";
