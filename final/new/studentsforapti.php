...
// {
//     $id=$_GET["mis"];
//     $sql2="UPDATE  selected_student SET status1=2 where mis='$id'";
...
$id=$_GET["mis"];
  $sql2="UPDATE  selected_student SET status1=2 where mis='$id' and cid=$cmid";
  $result2=$conn->query($sql2);

}
$sql='SELECT * FROM selected_student,company where selected_student.status=1 and company.cid=selected_student.cid and company.email=\''.$user.'\';' ;
...
echo '</tr>';
                                                   ...
                                                   echo'<td>'.$row_select["mis"].'</td>';
                                                    ...
                                                    echo'<td><form action="studentsforapti.php?mis=';echo $row_select["mis"];echo'"';echo' method="post"><button type="submit" name="submit1">Submit</button></form></td>';
