...
echo"<h4 style='text-align: right;''>
	...
	echo '<td><body><img class="img-thumbnail" src="getimage.php?id='.$var.'" height="200px" width="200px" ></body></td>';
		echo"<hr>";
...
<?php
/*
$sql9 = 'SELECT company.name FROM company,selected_student WHERE selected_student.status2=3 and company.cstatus=1 and selected_student.email= \''.$user.'\';';
...
*/
/*
$sql_salary = 'SELECT salary FROM selected_student WHERE  mis="$id"';
